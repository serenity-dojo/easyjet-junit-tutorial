...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.serenitydojo.easyjet.acceptancetests.cucumber.screenplay")
public class CucumberScreenplayTestSuite {
}
